<?php
  ...
  */
  ...
  define('META_DESCRIPTION','Geek Administrator Login Page');
...
<head>
  ...
  <meta content="" name="<?php echo META_DESCRIPTION; ?>" />
...
<body class="login">
  ...
  <div class="logo">
    <img src="<?php echo IMG_BASE_PATH; ?>logo_home.png" alt="" /> 
  </div>

  <div class="content">

       <form action="<?php echo base_url() ?>office/auth/login" method="post" id="iforms_f5" onsubmit="return iForms_s(5)">
         <input type="hidden" id="timereload" value="1" />
          <h3 class="form-title">Login to Geek CMS</h3>
